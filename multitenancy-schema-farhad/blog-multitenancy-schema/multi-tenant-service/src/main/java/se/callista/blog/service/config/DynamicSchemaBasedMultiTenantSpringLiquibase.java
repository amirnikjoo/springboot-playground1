...
public class DynamicSchemaBasedMultiTenantSpringLiquibase implements InitializingBean, ResourceLoaderAware {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.runOnAllSchemas(dataSource, masterClient.getTenants());
    }

    protected void runOnAllSchemas(DataSource dataSource, Collection<TenantDto> tenants) throws LiquibaseException {
