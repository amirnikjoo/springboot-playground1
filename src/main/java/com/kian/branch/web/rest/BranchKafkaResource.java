...
@RestController
@RequestMapping("/api/branch-kafka")
public class BranchKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BranchKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BranchKafkaResource(KafkaProperties kafkaProperties) {
