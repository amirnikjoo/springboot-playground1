...
@RestController
@RequestMapping("/api/acl-kafka")
public class AclKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AclKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AclKafkaResource(KafkaProperties kafkaProperties) {
