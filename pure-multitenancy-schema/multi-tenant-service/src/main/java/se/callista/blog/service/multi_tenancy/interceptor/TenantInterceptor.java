...
public class TenantInterceptor implements WebRequestInterceptor {
    ...
    public TenantInterceptor(
        ...
        System.out.println(">>>>>>> inside TenantInterceptor constructor...");
    ...
    public void preHandle(WebRequest request) {
        System.out.println(">>>>>>> inside TenantInterceptor preHandle..");
    ...
    public void postHandle(@NonNull WebRequest request, ModelMap model) {
        System.out.println(">>>>>>> inside TenantInterceptor postHandle..");
        TenantContext.clear();
    }

    @Override
    public void afterCompletion(@NonNull WebRequest request, Exception ex) {
        System.out.println(">>>>>>> inside TenantInterceptor afterCompletion..");
