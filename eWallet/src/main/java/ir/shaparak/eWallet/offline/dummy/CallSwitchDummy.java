...
public class CallSwitchDummy extends IHandler {
    ...
    public void process(Map map) throws Exception {
        ...
        //doCall switch and persist output
        //check output values with inputs > exception throws if needed
        log.debug("--{}, call switch successfully, walletId =  ", refNo, walletRequest.getWalletId());
    }
}
