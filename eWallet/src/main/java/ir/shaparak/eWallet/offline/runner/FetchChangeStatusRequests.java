...
public class FetchChangeStatusRequests extends IHandler {
    @Setter
    ...
    @Setter
    private IHandler offlineChangeStatusFlow;
    ...
    public void process(Map map) throws Exception {
        ...
        List<WalletRequest> requests = walletRequestRepository.getWalletRequestByHandledAndServiceId(
                WalletConstants.HANDLE, WalletConstants.SERVICE_ID_CHANGE_STATUS);
        if (requests.size() > 0)
    ...
    private class MySession implements Runnable {
        ...
        public void run() {
            ...
            try {
                offlineChangeStatusFlow.process(map);
        ...
        private void handledWithError(WalletRequest walletRequest, String message, Integer sourceId) {
            ...
            walletRequestRepository.changeWalletRequestByIdV2(
                    handle, walletRequest.getTryCount() + 1, actionCodes,
