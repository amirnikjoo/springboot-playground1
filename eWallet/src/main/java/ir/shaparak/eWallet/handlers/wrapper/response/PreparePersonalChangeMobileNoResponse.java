...
public class PreparePersonalChangeMobileNoResponse extends IHandler {
    @Override
    public void process(Map map) throws Exception {
        ...
        WalletResponseDto responseDto = new WalletResponseDto(requestDto.getStan(), refNo, requestDto.getWalletId(),
