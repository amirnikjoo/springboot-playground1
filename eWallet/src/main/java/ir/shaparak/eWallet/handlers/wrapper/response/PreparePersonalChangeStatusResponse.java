...
public class PreparePersonalChangeStatusResponse extends IHandler {
    @Override
    public void process(Map map) throws Exception {
        ...
        WalletResponseDto responseDto = new WalletResponseDto(walletChangeStatusDto.getStan(), refNo, walletChangeStatusDto.getWalletId(),
