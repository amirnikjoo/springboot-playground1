...
public class PreparePersonalChangeRiskLevelResponse extends IHandler {
    @Override
    public void process(Map map) throws Exception {
        ...
        WalletResponseDto responseDto = new WalletResponseDto(walletChangeRiskLevelDto.getStan(), refNo, walletChangeRiskLevelDto.getWalletId(),
