...
public class WrapChangeRiskLevelObject extends IHandler {
    @Override
    public void process(Map map) throws Exception {
        ...
        WalletChangeRiskLevelDto inputDto;  //todo: add officer object to Dto
        try {
            inputDto = mapper.readValue(jsonBodyString, WalletChangeRiskLevelDto.class);
        } catch (IOException e) {
