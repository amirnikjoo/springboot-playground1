...
public class WrapChangeStatusObject extends IHandler {
    @Override
    public void process(Map map) throws Exception {
        ...
        WalletChangeStatusDto inputDto;
        try {
            inputDto = mapper.readValue(jsonBodyString, WalletChangeStatusDto.class);
        } catch (IOException e) {
